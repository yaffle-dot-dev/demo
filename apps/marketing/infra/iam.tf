...
# =============================================================================
# This role allows GitHub Actions to deploy the marketing site to S3.
...
resource "aws_iam_role" "deploy" {
  name        = "yaffle-deploy-marketing-${local.name_suffix}"
  description = "Role for GitHub Actions to deploy marketing site to S3"
