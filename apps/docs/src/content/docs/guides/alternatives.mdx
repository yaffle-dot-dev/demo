...
<Aside type="note">
TFC's "speculative plans" show what would change but don't create infrastructure. Yaffle actually applies to isolated preview environments.
</Aside>
...
<Aside type="tip">
Most teams outgrow Atlantis within 1-2 years. See [Migrating from Atlantis](/docs/guides/atlantis/) for the upgrade path.
</Aside>
