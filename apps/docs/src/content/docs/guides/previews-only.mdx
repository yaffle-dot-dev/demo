...
<Aside type="tip">
  You probably already have an `environment` variable for staging vs production. The same pattern
  works for previews—just make sure resources use it for naming.
</Aside>
