...
<Aside type="tip">
The Yaffle module registry doesn't serve static module code. It serves the **outputs** of workspaces that have already been applied. Downstream teams consume live infrastructure, not blueprints.
</Aside>
...
- cross-org consumers can also be allowlisted when needed
