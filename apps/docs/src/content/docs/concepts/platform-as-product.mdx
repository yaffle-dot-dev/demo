...
<Aside type="tip">
The beta module contract serves immutable, versioned **output snapshots** from workspaces
that have already been applied. Downstream pinning and external publication are beta
implementation work, not current module-registry guarantees.
</Aside>
