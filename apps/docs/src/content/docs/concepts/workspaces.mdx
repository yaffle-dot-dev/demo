...
The contract requires sensitive values to be redacted before a snapshot exists. Publish
a secret reference such as an ARN instead of the secret value itself.
