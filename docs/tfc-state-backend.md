...
terraform {
  cloud {
    ...
    workspaces {
      name = "preview-pr-42-control-plane-infra"
    }
  }
}
...
CREATE TABLE workspaces (
  ...
  name TEXT NOT NULL,                           -- "preview-pr-42-control-plane-infra"
...
- Preview: `preview-pr-42-control-plane-infra`
...
```hcl
# Generated by Yaffle
# YAFFLE_TFC_API_HOST=yaffle.dev (or localhost:3000, preview-123.yaffle.dev, etc.)
terraform {
  cloud {
...
- Preview environments: `preview-123.yaffle.dev`
